...
<head>
    ...
    <style>
        ...
        .dgc-toast.success .dgc-toast-indicator {
        ...
        .dgc-toast.error .dgc-toast-indicator {
        ...
        .dgc-toast.warning .dgc-toast-indicator {
        ...
        .dgc-toast.info .dgc-toast-indicator {
        ...
        .dgc-toast .dgc-toast-close:hover {
            color: #212529;
        }
...
const DB_TBL_GRAPH_WIDGET_CATEGORY_MAPPING = "graph_widget_category_mapping";</code></pre></div>
                            ...
                            <?php if ($stepData['type'] === 'code_modifications'): ?>
                                <div class="mb-3">
                                    ...
                                    <div class="code-block mb-3" id="routes-code"><pre><code class="language-php">case "graph":
