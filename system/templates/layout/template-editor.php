                        ...
                        <form id="template-editor-form">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="template-category" name="category" required>
                                    ...
                                    <option value="columns" <?php echo ($template && $template->getCategory() === 'columns') ? 'selected' : ''; ?>>Columns</option>
                                    <option value="mixed" <?php echo ($template && $template->getCategory() === 'mixed') ? 'selected' : ''; ?>>Mixed</option>
