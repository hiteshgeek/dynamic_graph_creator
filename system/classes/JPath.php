<?php
    ...
    class JPath
    {
        ...
        public static function parseMenu($menu, $uid = null)
        {
            ...
            $user = Rapidkart::getInstance()->getUser();
        ...
        public static function absoluteUrl($url)
        {
            ...
            //$return_url_trimmed = rtrim(ltrim(implode('/', Rapidkart::getInstance()->getURL()), "/"), "/");
            //. '&return_url=' . SystemConfig::baseUrl() . "?urlq=" . ltrim($return_url_trimmed, "/")
        }
